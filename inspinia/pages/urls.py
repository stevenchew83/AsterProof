...
from inspinia.pages.views import problem_statement_detail_view
...
from inspinia.pages.views import technique_benchmark_list_view
...
urlpatterns = [
    ...
    path(
        "dashboard/techniques/catalog/rebuild/",
        technique_progress_catalog_rebuild_view,
        name="technique_progress_catalog_rebuild",
    ),
    path(
    ...
    path("dashboard/technique-benchmarks/", technique_benchmark_list_view, name="technique_benchmark_list"),
    ...
    path(
        "dashboard/problem-statements/<uuid:statement_uuid>/",
        problem_statement_detail_view,
