...
new CustomApexChart({
    ...
    options: () => ({
        ...
        colors: [ins('primary')], series: [{
            name: "Inspinia", data: [110, 110, 95, 95, 85, 85, 95, 95, 115, 115, 100, 100, 115, 116, 95, 95, 65, 85, 90]
        }],
        xaxis: {
...
new CustomApexChart({
    ...
    options: () => ({
        ...
        colors: [ins('danger'), ins('blue')], series: [{
            name: 'iPhone 16',
        ...
        xaxis: {
            ...
            row: {
                ...
                opacity: 0.2
            }, borderColor: [ins('border-color')], padding: {
                bottom: 5
            }
        }
    }),
...
const datetimeChart = new CustomApexChart({
    ...
    options: () => ({
        annotations: {
            yaxis: [{
                y: 30, borderColor: [ins('border-color')], label: {
                    show: true, text: 'Support', style: {
                        color: "#fff", background: [ins('danger')]
                    }
                }
            }], xaxis: [{
                x: new Date('14 Nov 2012').getTime(), borderColor: [ins('border-color')], yAxisIndex: 0, label: {
                    show: true, text: 'Rally', style: {
                        color: "#fff", background: [ins('warning')],
                    }
                }
            }]
        },
        ...
        colors: [ins('secondary')], dataLabels: {
            enabled: false
        },
        series: [{
            name: "Inspinia",
...
new CustomApexChart({
    ...
    options: () => ({
        ...
        plotOptions: {
            line: {
                colors: {
                    threshold: 0, colorAboveThreshold: [ins('success')], colorBelowThreshold: [ins('danger')],
                },
            },
        }
    })
        ...
        chart: {
            height: 175, type: 'area', toolbar: {
                ...
                enabled: true, xaxis: {
                    ...
                    color: ins('primary'), // background color of selection
                    opacity: 0.15
                }, stroke: {
                    color: ins('primary'), // border color of selection
                    width: 1, dashArray: 3
                }, handle: {
...
// STACKED AREA
//
// Helper function to generate smooth wave-style data with 2 decimal precision
function generateWaveStyleData(baseTime, count, min, max) {
    let series = [];
    for (let i = 0; i < count; i++) {
        // Generate the smooth sine wave value and round to 2 decimals
...
new CustomApexChart({
    ...
    options: () => ({
        ...
        }, colors: [ins('primary'), ins('secondary'), ins('gray')], dataLabels: {
            enabled: false
        }, stroke: {
...
new CustomApexChart({
    ...
    options: () => ({
        ...
        }], colors: [ins('warning'), ins('primary'), ins('secondary')], markers: {
            size: 0, style: 'full',
        }, stroke: {
            width: 3
        }, fill: {
