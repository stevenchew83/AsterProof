    ...
    options: () => ({
        backgroundColor: '#1e1f27', tooltip: {
            ...
            data: category, axisLine: {
                ...
                show: true, color: "#595e7a" // force label color (use your normal text color token here)
            }, splitLine: {
                lineStyle: {
            ...
            name: 'Samsung', type: 'bar', barWidth: 10, itemStyle: {
                ...
                color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{offset: 0, color: ins("primary")}, {
                    offset: 1,
                    color: ins("danger"),
                }])
            }, data: barData
    ...
    options: () => ({
        tooltip: {
            ...
            label: {
                ...
                rich: {
                    a: {
                        color: ins('body-color'), lineHeight: 22, align: 'center'
                    }, hr: {
                        borderColor: ins('border-color'), width: '100%', borderWidth: 1, height: 0
                    }, b: {
                        color: ins('body-color'), fontSize: 12, fontWeight: '600', lineHeight: 33
                    }, per: {
                        color: '#fff', backgroundColor: '#4C5058', padding: [3, 4], borderRadius: 4
                    }
                }
            },
            data: [{value: 1048, name: 'Baidu', itemStyle: {color: ins('primary')}}, {
                value: 335,
                name: 'Direct',
                itemStyle: {color: ins('secondary')}
            }, {value: 310, name: 'Email', itemStyle: {color: ins('info')}}, {
                value: 251,
                name: 'Google',
                itemStyle: {color: ins('warning')}
            }, {value: 234, name: 'Union Ads', itemStyle: {color: ins('danger')}}, {
                value: 147,
                name: 'Bing',
                itemStyle: {color: ins('purple')}
            }, {value: 135, name: 'Video Ads', itemStyle: {color: ins('dark')}}, {
                value: 102,
                name: 'Others',
                itemStyle: {color: ins('body-color')}
            },]
        }]
    })
})