...
class ProblemListItemAdmin(admin.ModelAdmin):
    list_display = ("problem_list", "position", "problem", "updated_at")
    list_filter = ("problem__contest", "problem__year")
    search_fields = ("problem_list__title", "problem__contest", "problem__problem", "problem__contest_year_problem")
