...
def _problem_picker_row(
    ...
    *,
    ...
    return {
        ...
        "comment": "",
        "core_ideas": _problem_note_value(problem, statement, "core_ideas_value"),
        "custom_title": "",
        "hint": "",
        "is_active": problem.is_active,
        "is_in_list": is_in_list,
        "mohs": problem.mohs,
        "pitfalls": _problem_note_value(problem, statement, "pitfalls_value"),
        "problem_code": problem.problem,
        "problem_label": label,
        "problem_uuid": str(problem.problem_uuid),
        "rationale": _problem_note_value(problem, statement, "rationale_value"),
